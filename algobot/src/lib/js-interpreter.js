...
var ba = "undefined" === typeof globalThis ? this || window : globalThis,
	ca = function (a) {
		function b(f) {
			return 48 > f ? 36 === f : 58 > f ? !0 : 65 > f ? !1 : 91 > f ? !0 : 97 > f ? 95 === f : 123 > f ? !0 : 170 <= f && Kc.test(String.fromCharCode(f));
		}
		function d(f) {
			return 65 > f ? 36 === f : 91 > f ? !0 : 97 > f ? 95 === f : 123 > f ? !0 : 170 <= f && Qb.test(String.fromCharCode(f));
		}
		function c(f, h) {
			var l = r;
			for (var n = 1, w = 0; ; ) {
				Ta.lastIndex = w;
				var K = Ta.exec(l);
				if (K && K.index < f) (++n, (w = K.index + K[0].length));
				else break;
			}
			l = { line: n, eb: f - w };
			h += " (" + l.line + ":" + l.eb + ")";
		...
		function e(f) {
			f = f.split(" ");
			for (var h = Object.create(null), l = 0; l < f.length; l++) h[f[l]] = !0;
			return function (n) {
				return h[n] || !1;
			};
		}
		...
		function q() {
			for (var f = m, h = z.Aa && z.D && new g(), l = r.charCodeAt((m += 2)); m < oa && 10 !== l && 13 !== l && 8232 !== l && 8233 !== l; ) (++m, (l = r.charCodeAt(m)));
			z.Aa && z.Aa(!1, r.slice(f + 2, m), f, m, h, z.D && new g());
		}
		function C() {
			for (; m < oa; ) {
				var f = r.charCodeAt(m);
				if (32 === f) ++m;
				else if (13 === f) (++m, (f = r.charCodeAt(m)), 10 === f && ++m, z.D && (++ka, (W = m)));
				else if (10 === f || 8232 === f || 8233 === f) (++m, z.D && (++ka, (W = m)));
				else if (8 < f && 14 > f) ++m;
				else if (47 === f)
					if (((f = r.charCodeAt(m + 1)), 42 === f)) {
						...
						m = n + 2;
						if (z.D) for (Ta.lastIndex = l; (f = Ta.exec(r)) && f.index < m; ) (++ka, (W = f.index + f[0].length));
						z.Aa && z.Aa(!0, r.slice(l + 2, n), l, m, h, z.D && new g());
					} else if (47 === f) q();
					else break;
				else if (160 === f) ++m;
				else if (5760 <= f && Lc.test(String.fromCharCode(f))) ++m;
				else break;
			}
		}
		function R(f) {
			switch (f) {
				...
				case 39:
					...
					for (var h = ""; ; ) {
						...
						if (92 === l) {
							...
							"0" === n && (n = null);
							++m;
							if (n) (S && c(m - 2, "Octal literal in strict mode"), (h += String.fromCharCode(parseInt(n, 8))), (m += n.length - 1));
							else
								switch (l) {
									case 110:
										h += "\n";
						...
						} else ((13 !== l && 10 !== l && 8232 !== l && 8233 !== l) || c(I, "Unterminated string constant"), (h += String.fromCharCode(l)), ++m);
					}
					return;
				case 47:
					f = r.charCodeAt(m + 1);
					ya ? (++m, Ub()) : 61 === f ? L(la, 2) : L(Vb, 1);
					return;
				case 37:
				case 42:
				...
				case 38:
					h = r.charCodeAt(m + 1);
					h === f ? L(124 === f ? Wb : Xb, 2) : 61 === h ? L(la, 2) : L(124 === f ? Nc : Oc, 1);
					return;
				case 94:
				...
				case 45:
					h = r.charCodeAt(m + 1);
					h === f ? (45 === h && 62 === r.charCodeAt(m + 2) && Wa.test(r.slice(fa, m)) ? ((m += 3), q(), C(), ha()) : L(Qc, 2)) : 61 === h ? L(la, 2) : L(Rc, 1);
					return;
				case 60:
				case 62:
					h = r.charCodeAt(m + 1);
					l = 1;
					h === f ? ((l = 62 === f && 62 === r.charCodeAt(m + 2) ? 3 : 2), 61 === r.charCodeAt(m + l) ? L(la, l + 1) : L(Sc, l)) : 33 === h && 60 === f && 45 === r.charCodeAt(m + 2) && 45 === r.charCodeAt(m + 3) ? ((m += 4), q(), C(), ha()) : (61 === h && (l = 61 === r.charCodeAt(m + 2) ? 3 : 2), L(Tc, l));
					return;
				case 61:
				case 33:
					61 === r.charCodeAt(m + 1) ? L(Uc, 61 === r.charCodeAt(m + 2) ? 3 : 2) : L(61 === f ? Yb : Zb, 1);
					return;
				case 126:
					return L(Zb, 1);
			}
		...
		function ha(f) {
			...
			if (m >= oa) return k(gb);
			f = r.charCodeAt(m);
			if (d(f) || 92 === f) return $b();
			if (!1 === R(f)) {
				f = String.fromCharCode(f);
				if ("\\" === f || Qb.test(f)) return $b();
		...
		function Ub() {
			...
			f = r.slice(l, m);
			++m;
			(h = ac()) && !/^[gmi]*$/.test(h) && c(l, "Invalid regexp flag");
			try {
		...
		function Ba(f, h) {
			for (var l = m, n = 0, w = void 0 === h ? Infinity : h, K = 0; K < w; ++K) {
				var O = r.charCodeAt(m);
				O = 97 <= O ? O - 97 + 10 : 65 <= O ? O - 65 + 10 : 48 <= O && 57 >= O ? O - 48 : Infinity;
				if (O >= f) break;
				++m;
				n = n * f + O;
			}
			return m === l || (void 0 !== h && m - l !== h) ? null : n;
		}
		function Rb(f) {
			var h = m,
				l = !1,
			...
			f = r.charCodeAt(m);
			if (69 === f || 101 === f) ((f = r.charCodeAt(++m)), (43 !== f && 45 !== f) || ++m, null === Ba(10) && c(h, "Invalid number"), (l = !0));
			d(r.charCodeAt(m)) && c(m, "Identifier directly after number");
			f = r.slice(h, m);
			var w;
			l ? (w = parseFloat(f)) : n && 1 !== f.length ? (/[89]/.test(f) || S ? c(h, "Invalid number") : (w = parseInt(f, 8))) : (w = parseInt(f, 10));
			k(Ca, w);
		}
		function Va(f) {
			f = Ba(16, f);
		...
		function jb(f) {
			S = f;
			m = I;
			if (z.D) for (; m < W; ) ((W = r.lastIndexOf("\n", W - 2) + 1), --ka);
			C();
			ha();
		}
		function cc() {
		...
		function lb(f) {
			return "ExpressionStatement" === f.type && "Literal" === f.pa.type && "use strict" === f.pa.value;
		}
		function E(f) {
			return x === f ? (B(), !0) : !1;
		}
		function Xa() {
			return !z.ec && (x === gb || x === pa || Wa.test(r.slice(fa, I)));
		}
		function ma() {
			E(Y) || Xa() || Z();
		}
		...
		function Ya(f) {
			...
			S && "Identifier" === f.type && Za(f.name) && c(f.start, "Assigning to " + f.name + " in strict mode");
		}
		function U() {
			(x === Vb || (x === la && "/=" === T)) && ha(!0);
			var f = x,
			...
			switch (f) {
				...
				case ec:
					...
					return y(h, l ? "BreakStatement" : "ContinueStatement");
				case fc:
					return (B(), ma(), y(h, "DebuggerStatement"));
				case gc:
					return (B(), G.push(nb), (h.body = U()), G.pop(), F(ob), (h.test = Da()), ma(), y(h, "DoWhileStatement"));
				case hc:
					B();
					G.push(nb);
					F(X);
					if (x === Y) return pb(h, null);
					if (x === qb) return ((f = M()), B(), ic(f, !0), y(f, "VariableDeclaration"), 1 === f.ia.length && E($a) ? jc(h, f) : pb(h, f));
					f = N(!1, !0);
					return E($a) ? (Ya(f), jc(h, f)) : pb(h, f);
				case rb:
					return (B(), sb(h, !0));
				case kc:
					return (B(), (h.test = Da()), (h.fa = U()), (h.alternate = E(lc) ? U() : null), y(h, "IfStatement"));
				case mc:
					return (Ea || z.Gb || c(I, "'return' outside of function"), B(), E(Y) || Xa() ? (h.J = null) : ((h.J = N()), ma()), y(h, "ReturnStatement"));
				case tb:
					B();
					h.Nb = Da();
					h.tb = [];
					F(za);
					for (G.push(Xc); x !== pa; ) x === ub || x === nc ? ((f = x === ub), n && y(n, "SwitchCase"), h.tb.push((n = M())), (n.fa = []), B(), f ? (n.test = N()) : (l && c(hb, "Multiple default clauses"), (l = !0), (n.test = null)), F(Aa)) : (n || Z(), n.fa.push(U()));
					n && y(n, "SwitchCase");
					B();
					G.pop();
					return y(h, "SwitchStatement");
				case oc:
					return (B(), Wa.test(r.slice(fa, I)) && c(fa, "Illegal newline after throw"), (h.J = N()), ma(), y(h, "ThrowStatement"));
				case pc:
					return (B(), (h.block = Fa()), (h.Ha = null), x === qc && ((f = M()), B(), F(X), (f.Wa = aa()), S && Za(f.Wa.name) && c(f.Wa.start, "Binding " + f.Wa.name + " in strict mode"), F(V), (f.body = Fa()), (h.Ha = y(f, "CatchClause"))), (h.ib = E(rc) ? Fa() : null), h.Ha || h.ib || c(h.start, "Missing catch or finally clause"), y(h, "TryStatement"));
				case qb:
					return (B(), ic(h), ma(), y(h, "VariableDeclaration"));
				case ob:
					return (B(), (h.test = Da()), G.push(nb), (h.body = U()), G.pop(), y(h, "WhileStatement"));
				case sc:
					return (S && c(I, "'with' in strict mode"), B(), (h.object = Da()), (h.body = U()), y(h, "WithStatement"));
				case za:
					return Fa();
				case Y:
					return (B(), y(h, "EmptyStatement"));
				default:
					l = T;
					w = N();
					if (f === ra && "Identifier" === w.type && E(Aa)) {
						for (n = 0; n < G.length; ++n) G[n].name === l && c(w.start, "Label '" + l + "' is already declared");
						G.push({ name: l, kind: x.ca ? "loop" : x === tb ? "switch" : null });
						h.body = U();
						G.pop();
						h.label = w;
		...
		function ic(f, h) {
			...
			for (f.kind = "var"; ; ) {
				var l = M();
				l.id = aa();
				S && Za(l.id.name) && c(l.id.start, "Binding " + l.id.name + " in strict mode");
				l.za = E(Yb) ? N(!0, h) : null;
				f.ia.push(y(l, "VariableDeclarator"));
				if (!E(ea)) break;
			}
		}
		function N(f, h) {
			...
			if (!f && x === ea) {
				f = ia(l);
				for (f.xb = [l]; E(ea); ) f.xb.push(vb(h));
		...
		function vb(f) {
			...
			return x.Bb ? ((l = ia(h)), (l.operator = T), (l.left = h), B(), (l.right = vb(f)), Ya(h), y(l, "AssignmentExpression")) : h;
		}
		function wb(f, h, l) {
			var n = x.K;
			if (null !== n && (!l || x !== $a) && n > h) {
		...
		function xb() {
			...
			for (h = Ga(ab()); x.ac && !Xa(); ) ((f = ia(h)), (f.operator = T), (f.prefix = !1), (f.J = h), Ya(h), B(), (h = y(f, "UpdateExpression")));
			return h;
		}
		function Ga(f, h) {
			if (E(Sb)) {
				...
				l.Ya = aa(!0);
				l.fb = !1;
				return Ga(y(l, "MemberExpression"), h);
			}
			return E(db) ? ((l = ia(f)), (l.object = f), (l.Ya = N()), (l.fb = !0), F(eb), Ga(y(l, "MemberExpression"), h)) : !h && E(X) ? ((l = ia(f)), (l.callee = f), (l.arguments = yb(V, !1)), Ga(y(l, "CallExpression"), h)) : f;
		}
		function ab() {
			switch (x) {
				case tc:
				...
				case Ua:
				case bc:
					return ((f = M()), (f.value = T), (f.raw = r.slice(I, na)), B(), y(f, "Literal"));
				case uc:
				case vc:
				case wc:
					return ((f = M()), (f.value = x.cb), (f.raw = x.l), B(), y(f, "Literal"));
				case X:
					f = fb;
					var h = I;
					B();
					...
					return l;
				case db:
					return ((f = M()), B(), (f.elements = yb(eb, !0, !0)), y(f, "ArrayExpression"));
				case za:
					f = M();
					h = !0;
					l = !1;
					...
					for (B(); !E(pa); ) {
						if (h) h = !1;
						else if ((F(ea), z.sb && E(pa))) break;
						var n = { key: x === Ca || x === Ua ? ab() : aa(!0) },
							w = !1;
						if (E(Aa)) {
							n.value = N(!0);
							var K = (n.kind = "init");
						} else "Identifier" !== n.key.type || ("get" !== n.key.name && "set" !== n.key.name) ? Z() : ((w = l = !0), (K = n.kind = n.key.name), (n.key = x === Ca || x === Ua ? ab() : aa(!0)), x !== X && Z(), (n.value = sb(M(), !1)));
						if ("Identifier" === n.key.type && (S || l))
							for (var O = 0; O < f.h.length; ++O) {
								var sa = f.h[O];
								if (sa.key.name === n.key.name) {
									var zb = K === sa.kind || (w && "init" === sa.kind) || ("init" === K && ("get" === sa.kind || "set" === sa.kind));
									zb && !S && "init" === K && "init" === sa.kind && (zb = !1);
				...
				case rb:
					return ((f = M()), B(), sb(f, !1));
				case xc:
					return ((f = M()), B(), (f.callee = Ga(ab(), !0)), (f.arguments = E(X) ? yb(V, !1) : Yc), y(f, "NewExpression"));
			}
			Z();
		}
		function sb(f, h) {
			...
			f.sa = [];
			var l = !0;
			for (F(X); !E(V); ) (l ? (l = !1) : F(ea), f.sa.push(aa()));
			l = Ea;
			var n = G;
			Ea = !0;
			G = [];
			...
			Ea = l;
			G = n;
			if (S || (f.body.body.length && lb(f.body.body[0]))) for (l = f.id ? -1 : 0; l < f.sa.length; ++l) if (((n = 0 > l ? f.id : f.sa[l]), (yc(n.name) || Za(n.name)) && c(n.start, "Defining '" + n.name + "' in strict mode"), 0 <= l)) for (var w = 0; w < l; ++w) n.name === f.sa[w].name && c(n.start, "Argument name clash in strict mode");
			return y(f, h ? "FunctionDeclaration" : "FunctionExpression");
		}
		function yb(f, h, l) {
			for (var n = [], w = !0; !E(f); ) {
				if (w) w = !1;
				else if ((F(ea), h && z.sb && E(f))) break;
				n.push(l && x === ea ? null : N(!0));
			}
			return n;
		}
		function aa(f) {
			...
			x === ra ? (!f && ((z.yb && Zc(T)) || (S && yc(T))) && -1 === r.slice(I, na).indexOf("\\") && c(I, "The keyword '" + T + "' is reserved"), (h.name = T)) : f && x.l ? (h.name = x.l) : Z();
			ya = !1;
			B();
			return y(h, "Identifier");
		}
		a.version = "0.5.0";
		var z,
			r = "",
		...
		a.parse = function (f, h) {
			...
			oa = r.length;
			z = h || {};
			for (var l in zc) Object.prototype.hasOwnProperty.call(z, l) || (z[l] = zc[l]);
			kb = z.sourceFile;
			ka = 1;
			m = W = 0;
			ya = !0;
			...
			h = !0;
			l || (f.body = []);
			for (; x !== gb; ) ((l = U()), f.body.push(l), h && lb(l) && jb(!0), (h = !1));
			return y(f, "Program");
		};
		var zc = { ec: !1, sb: !0, yb: !1, Gb: !1, D: !1, Aa: null, Za: !1, bc: null, sourceFile: null, vb: null },
			m = 0,
			I = 0,
			na = 0,
			fb,
			...
			wc = { l: "false", cb: !1 },
			$a = { l: "in", K: 7, m: !0 },
			Wc = { break: mb, case: ub, catch: qc, continue: ec, debugger: fc, default: nc, do: gc, else: lc, finally: rc, for: hc, function: rb, if: kc, return: mc, switch: tb, throw: oc, try: pc, var: qb, while: ob, with: sc, null: uc, true: vc, false: wc, new: xc, in: $a, instanceof: { l: "instanceof", K: 7, m: !0 }, this: tc, typeof: { l: "typeof", prefix: !0, m: !0 }, void: { l: "void", prefix: !0, m: !0 }, delete: { l: "delete", prefix: !0, m: !0 } },
			db = { type: "[", m: !0 },
			eb = { type: "]" },
			za = { type: "{", m: !0 },
			pa = { type: "}" },
			...
			yc = e("implements interface let package private protected public static yield"),
			Za = e("eval arguments"),
			Vc = e("break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this"),
			Lc = /[\u1680\u180e\u2000-\u200a\u202f\u205f\u3000\ufeff]/,
			Qb = RegExp(
...
"object" === typeof exports && "object" === typeof module ? ca(exports) : "function" === typeof define && define.ic ? define(["exports"], ca) : ca(ba.j || (ba.j = {})); /*
...
function t(a, b) {
	...
	a = /^step([A-Z]\w*)$/;
	var g, k;
	for (k in this) "function" === typeof this[k] && (g = k.match(a)) && (this.rb[g[1]] = this[k].bind(this));
	this.M = ja(this, this.va, null);
	this.Qa = this.M.object;
	this.va = da(this.Z.join("\n"), "polyfills");
	this.Z = void 0;
	ta(this.va);
...
var ua = { DONE: 0, STEP: 1, TASK: 2, ASYNC: 3 },
	va = { D: !0, jc: 5 },
	wa = { configurable: !0, enumerable: !0, writable: !1 },
	v = { configurable: !0, enumerable: !1, writable: !0 },
	A = { configurable: !0, enumerable: !1, writable: !1 },
	xa = { configurable: !1, enumerable: !1, writable: !1 },
	Ha = { configurable: !1, enumerable: !0, writable: !0 },
	Ia = { STEP_ERROR: !0 },
	Ja = { SCOPE_REFERENCE: !0 },
	Ka = { VALUE_IN_DESCRIPTOR: !0 },
	La = { REGEXP_TIMEOUT: !0 },
	Ma = [],
	Na = null,
	Oa = null,
	Pa = "undefined" === typeof globalThis ? this || window : globalThis,
	Qa = ["onmessage = function(e) {", "var result;", "var data = e.data;", "switch (data[0]) {", "case 'split':", "result = data[1].split(data[2], data[3]);", "break;", "case 'match':", "result = data[1].match(data[2]);", "break;", "case 'search':", "result = data[1].search(data[2]);", "break;", "case 'replace':", "result = data[1].replace(data[2], data[3]);", "break;", "case 'exec':", "var regexp = data[1];", "regexp.lastIndex = data[2];", "result = [regexp.exec(data[3]), data[1].lastIndex];", "break;", "default:", "throw Error('Unknown RegExp operation: ' + data[0]);", "}", "postMessage(result);", "close();", "};"];
function Ra(a) {
	var b = a >>> 0;
...
p.nb = function () {
	...
	do {
		...
		if (this.wa) break;
			...
			d = this.$[0];
			if (!d || d.time > Date.now()) d = null;
			else {
				this.$.shift();
				0 <= d.j && Ab(this, d, d.j);
				var c = new u(d.node, d.scope);
				d.o && ((c.ma = 2), (c.C = this.Qa), (c.aa = d.o), (c.Ta = !0), (c.G = d.A));
				d = c;
			}
			if (!d) break;
		}
		...
		try {
			...
			if (k !== Ia) throw (this.value !== k && (this.value = void 0), k);
		} finally {
			Oa = e;
		}
		g && a.push(g);
		if (this.R) throw ((this.value = void 0), Error("Getter not supported in this context"));
		if (this.Ma) throw ((this.value = void 0), Error("Setter not supported in this context"));
...
p.Wb = function () {
	if (this.wa) return ua.ASYNC;
	var a = this.j;
	return !(a = a[a.length - 1]) || ("Program" === a.node.type && a.done) ? ((a = this.$[0]) ? (a.time > Date.now() ? ua.TASK : ua.STEP) : ua.DONE) : ua.STEP;
};
function Bb(a, b) {
	a.g(b, "NaN", NaN, xa);
	...
	for (
		...
		((d = (function (g) {
			...
			a.g(b, c[e][1], a.i(d, !1), v));
	d = function (g) {
		return Nb(a, !1, arguments);
	};
	a.g(b, "setTimeout", a.i(d, !1), v);
	d = function (g) {
		return Nb(a, !0, arguments);
	};
...
function Cb(a, b) {
	...
	var c = function (e) {
		...
		return Pb(a, R.body[0].pa, a.M, "anonymous");
	};
	a.P = a.i(c, !0);
	...
	c = function (e, g, k) {
		...
		q.C = g;
		q.G = [];
		null !== k && void 0 !== k && (k instanceof D ? (q.G = Array.from(k.h)) : H(a, a.o, "CreateListFromArrayLike called on non-object"));
		q.hb = !1;
	};
	J(a, a.P, "apply", c);
	a.Z.push("(function(){var d=Function.prototype.apply;Function.prototype.apply=function(e,b){for(var c=[],a=0;b&&a<b.length;a++)c[a]=b[a];return d(this,e,c)}})();");
	c = function (e) {
	...
	J(a, a.P, "call", c);
	a.Z.push('Object.defineProperty(Function.prototype,"bind",{configurable:!0,writable:!0,value:function(c){if("function"!==typeof this)throw TypeError("What is trying to be bound is not callable");var d=Array.prototype.slice.call(arguments,1),e=this,a=function(){},b=function(){return e.apply(this instanceof a?this:c,d.concat(Array.prototype.slice.call(arguments)))};this.prototype&&(a.prototype=this.prototype);b.prototype=new a;return b}});');
	c = function () {
		return String(this);
	};
	J(a, a.P, "toString", c);
	a.g(a.P, "toString", a.i(c, !1), v);
	c = function () {
		return this.valueOf();
	};
	J(a, a.P, "valueOf", c);
	a.g(a.P, "valueOf", a.i(c, !1), v);
}
function Db(a, b) {
	function d(e) {
		(void 0 !== e && null !== e) || H(a, a.o, "Cannot convert '" + e + "' to object");
	}
	var c = function (e) {
		if (void 0 === e || null === e) return Ac(a) ? this : a.s(a.L);
		if (!(e instanceof D)) {
			var g = a.s(Bc(a, e));
			g.data = e;
			return g;
	...
	c = function (e) {
		d(e);
		return a.S(Object.getOwnPropertyNames(e instanceof D ? e.h : e));
	};
	a.g(a.u, "getOwnPropertyNames", a.i(c, !1), v);
	c = function (e) {
		d(e);
		e instanceof D && (e = e.h);
		return a.S(Object.keys(e));
	};
	a.g(a.u, "keys", a.i(c, !1), v);
	c = function (e) {
		if (null === e) return a.s(null);
		e instanceof D || H(a, a.o, "Object prototype may only be an Object or null, not " + e);
		return a.s(e);
	};
	a.g(a.u, "create", a.i(c, !1), v);
	a.Z.push("(function(){var c=Object.create;Object.create=function(a,b){a=c(a);b&&Object.defineProperties(a,b);return a}})();");
	c = function (e, g, k) {
		g = String(g);
		e instanceof D || H(a, a.o, "Object.defineProperty called on non-object: " + e);
		k instanceof D || H(a, a.o, "Property description must be an object");
		!e.preventExtensions || g in e.h || H(a, a.o, "Can't define property '" + g + "', object is not extensible");
		a.g(e, g, Ka, k.h);
		return e;
	};
	a.g(a.u, "defineProperty", a.i(c, !1), v);
	a.Z.push('(function(){var d=Object.defineProperty;Object.defineProperty=function(e,c,a){var b={};"configurable"in a&&(b.configurable=a.configurable);"enumerable"in a&&(b.enumerable=a.enumerable);"writable"in a&&(b.writable=a.writable);"value"in a&&(b.value=a.value);"get"in a&&(b.get=a.get);"set"in a&&(b.set=a.set);return d(e,c,b)}})();\nObject.defineProperty(Object,"defineProperties",{configurable:!0,writable:!0,value:function(d,e){for(var c=Object.keys(e),a=0;a<c.length;a++)Object.defineProperty(d,c[a],e[c[a]]);return d}});');
	c = function (e, g) {
		e instanceof D || H(a, a.o, "Object.getOwnPropertyDescriptor called on non-object: " + e);
		g = String(g);
		if (g in e.h) {
			...
			e = e.ea[g];
			g = a.s(a.L);
			q || e ? (a.g(g, "get", q), a.g(g, "set", e)) : (a.g(g, "value", k.value), a.g(g, "writable", k.writable));
...
function Eb(a, b) {
	var d = function (c) {
		var e = Ac(a) ? this : Cc(a),
			g = arguments[0];
		if (1 === arguments.length && "number" === typeof g) (isNaN(Ra(g)) && H(a, a.$a, "Invalid array length: " + g), (e.h.length = g));
		else {
	...
	a.g(a.ua, "isArray", a.i(d, !1), v);
	a.g(a.Na, "length", 0, { configurable: !1, enumerable: !1, writable: !0 });
	a.Na.H = "Array";
	a.Z.push(
...
function Fb(a, b) {
	var d = function (c) {
		...
		return Ac(a) ? ((this.data = c), this) : c;
	};
	a.F = a.i(d, !0);
	a.g(b, "String", a.F, v);
	a.g(a.F, "fromCharCode", a.i(String.fromCharCode, !1), v);
	...
	d = function (c, e, g) {
		var k = String(this);
		e = e ? Number(e) : void 0;
		if (P(a, c, a.I) && ((c = c.data), Dc(a, c, g), 2 === a.REGEXP_MODE)) {
			if (Na) ((c = Ec(a, "string.split(separator, limit)", { string: k, separator: c, limit: e }, c, g)), c !== La && g(a.S(c)));
			else {
				var q = a.la(),
					C = Fc(a, c, q, g);
				q.onmessage = function (R) {
					clearTimeout(C);
					g(a.S(R.data));
				};
	...
	d = function (c, e) {
		...
		Dc(a, c, e);
		if (2 === a.REGEXP_MODE)
			if (Na) ((c = Ec(a, "string.match(regexp)", { string: g, regexp: c }, c, e)), c !== La && e(c && Hc(a, c)));
			else {
				var k = a.la(),
					q = Fc(a, c, k, e);
	...
	d = function (c, e) {
		...
		Dc(a, c, e);
		if (2 === a.REGEXP_MODE)
			if (Na) ((c = Ec(a, "string.search(regexp)", { string: g, regexp: c }, c, e)), c !== La && e(c));
			else {
				var k = a.la(),
					q = Fc(a, c, k, e);
				k.onmessage = function (C) {
	...
	d = function (c, e, g) {
		...
		e = String(e);
		if (P(a, c, a.I) && ((c = c.data), Dc(a, c, g), 2 === a.REGEXP_MODE)) {
			if (Na) ((c = Ec(a, "string.replace(substr, newSubstr)", { string: k, substr: c, newSubstr: e }, c, g)), c !== La && g(c));
			else {
				var q = a.la(),
					C = Fc(a, c, q, g);
				q.onmessage = function (R) {
...
function Ib(a, b) {
	...
	a.g(b, "Date", a.W, v);
	a.g(a.W, "now", a.i(Date.now, !1), v);
	a.g(a.W, "parse", a.i(Date.parse, !1), v);
	a.g(a.W, "UTC", a.i(Date.UTC, !1), v);
	...
	for (var c = 0; c < b.length; c++)
		((d = (function (e) {
			return function (g) {
				...
				for (var q = [], C = 0; C < arguments.length; C++) q[C] = a.T(arguments[C]);
...
function Jb(a, b) {
	var d = function (c, e) {
		if (Ac(a)) var g = this;
			...
			if (void 0 === e && P(a, c, a.I)) return c;
			g = a.s(a.Pa);
		}
		c = void 0 === c ? "" : String(c);
		e = e ? String(e) : "";
	...
	a.Z.push('Object.defineProperty(RegExp.prototype,"test",{configurable:!0,writable:!0,value:function(a){return!!this.exec(a)}});');
	d = function (c, e) {
		var g = this.data;
		c = String(c);
		...
		Dc(a, g, e);
		if (2 === a.REGEXP_MODE)
			if (Na) ((c = Ec(a, "regexp.exec(string)", { string: c, regexp: g }, g, e)), c !== La && (a.g(this, "lastIndex", g.lastIndex), e(Hc(a, c))));
			else {
				var k = a.la(),
					q = Fc(a, g, k, e),
					C = this;
		...
		else ((c = g.exec(c)), a.g(this, "lastIndex", g.lastIndex), e(Hc(a, c)));
	};
	Gc(a, a.I, "exec", d);
}
function Hc(a, b) {
...
function Kb(a, b) {
	function d(c) {
		var e = a.i(function (g) {
			var k = Ac(a) ? this : a.ga(e);
			Jc(a, k, g);
			return k;
		}, !0);
		a.g(e, "prototype", a.ga(a.A), v);
...
function Jc(a, b, d) {
	...
	for (var c = a.j.length - 1; 0 <= c; c--) {
		var e = a.j[c],
			g = e.node;
		"CallExpression" === g.type && (e = e.aa) && d.length && (d[d.length - 1].Lb = a.N(e, "name"));
		!g.O || (d.length && "CallExpression" !== g.type) || d.push({ Kb: g.O });
	}
	c = String(a.N(b, "name"));
	g = String(a.N(b, "message"));
	g = c + ": " + g + "\n";
...
p.la = function () {
	var a = this.la.Jb;
	a || ((a = new Blob([Qa.join("\n")], { type: "application/javascript" })), (this.la.Jb = a));
...
function Ec(a, b, d, c, e) {
	...
	try {
		...
		(e(null), H(a, a.A, "RegExp Timeout: " + c));
	}
	return La;
}
function Dc(a, b, d) {
	...
	c || (d(null), H(a, a.A, "Regular expressions not supported: " + b));
}
function Fc(a, b, d, c) {
...
function $c(a, b, d) {
	var c = a.s(a.X);
	d ? ((d = a.s(a.L)), a.g(c, "prototype", d, v), a.g(d, "constructor", c, v)) : (c.zb = !0);
	a.g(c, "length", b, A);
	c.H = "Function";
	return c;
}
function Pb(a, b, d, c) {
	var e = $c(a, b.sa.length, !0);
	e.Xa = d;
	e.node = b;
...
p.S = function (a, b) {
	...
	if (a instanceof Date) return ((c = this.s(this.ob)), (c.data = new Date(a.valueOf())), b.da.push(c), c);
	var e;
	a instanceof Number ? (e = this.ga(this.V)) : a instanceof String ? (e = this.ga(this.F)) : a instanceof Boolean && (e = this.ga(this.Oa));
	if (e) return ((e.data = a.valueOf()), b.da.push(e), e);
	if ("function" === typeof a) {
		var g = this;
		c = Object.getOwnPropertyDescriptor(a, "prototype");
		c = this.i(function () {
			var k = Array.prototype.slice.call(arguments).map(function (q) {
				return g.T(q);
			});
			k = a.apply(g, k);
			return g.S(k);
	...
	b.da.push(e);
	for (c in a) this.g(e, c, this.S(a[c], b));
	return e;
};
p.T = function (a, b) {
	if (null === a || void 0 === a || !0 === a || !1 === a || "string" === typeof a || "number" === typeof a) return a;
	...
	if (P(this, a, this.W)) return ((a = new Date(a.data.valueOf())), b.ja.push(a), a);
	if (P(this, a, this.V) || P(this, a, this.F) || P(this, a, this.Oa)) return ((a = Object(a.data)), b.ja.push(a), a);
	d = P(this, a, this.ua) ? [] : {};
	b.ja.push(d);
	for (c in a.h) {
...
function Bc(a, b) {
	switch (typeof b) {
		case "number":
			return a.V.h.prototype;
		case "boolean":
			return a.Oa.h.prototype;
		case "string":
			return a.F.h.prototype;
	}
	return b ? b.Ca : null;
}
p.N = function (a, b) {
	if (this.R) throw Error("Getter not supported in that context");
	b = String(b);
	(void 0 !== a && null !== a) || H(this, this.o, "Cannot read property '" + b + "' of " + a);
	if ("object" === typeof a && !(a instanceof D)) throw TypeError("Expecting native value or pseudo object");
	if ("length" === b) {
		if (P(this, a, this.F)) return String(a).length;
	} else if (64 > b.charCodeAt(0) && P(this, a, this.F)) {
		var d = Sa(b);
		if (!isNaN(d) && d < String(a).length) return String(a)[d];
	}
	do if (a.h && b in a.h) return (d = a.ba[b]) ? ((this.R = !0), d) : a.h[b];
	while ((a = Bc(this, a)));
};
function ad(a, b, d) {
	if (!(b instanceof D)) throw TypeError("Primitive data type has no properties");
	d = String(d);
	if ("length" === d && P(a, b, a.F)) return !0;
	if (P(a, b, a.F)) {
		var c = Sa(d);
...
p.g = function (a, b, d, c) {
	if (this.Ma) throw Error("Setter not supported in that context");
	b = String(b);
	(void 0 !== a && null !== a) || H(this, this.o, "Cannot set property '" + b + "' of " + a);
	if ("object" === typeof a && !(a instanceof D)) throw TypeError("Expecting native value or pseudo object");
	c && ("get" in c || "set" in c) && ("value" in c || "writable" in c) && H(this, this.o, "Invalid property descriptor. Cannot both specify accessors and a value or writable attribute");
	var e = !this.j || bd(this).U;
	if (a instanceof D) {
		if (P(this, a, this.F)) {
			var g = Sa(b);
			if ("length" === b || (!isNaN(g) && g < String(a).length)) {
				e && H(this, this.o, "Cannot assign to read only property '" + b + "' of String '" + a.data + "'");
				return;
			}
		}
		if ("Array" === a.H)
		...
		if (!a.preventExtensions || b in a.h)
			if (c) {
				...
				"writable" in c && ((e.writable = c.writable), delete a.ba[b], delete a.ea[b]);
				"value" in c ? ((e.value = c.value), delete a.ba[b], delete a.ea[b]) : d !== Ka && ((e.value = d), delete a.ba[b], delete a.ea[b]);
				try {
					Object.defineProperty(a.h, b, e);
				} catch (q) {
					H(this, this.o, "Cannot redefine property: " + b);
				}
				"get" in c && !c.get && delete a.ba[b];
				"set" in c && !c.set && delete a.ea[b];
			} else {
				if (d === Ka) throw ReferenceError("Value not specified");
				for (c = a; !(b in c.h); )
					if (((c = Bc(this, c)), !c)) {
						c = a;
						break;
					}
				if (c.ea && c.ea[b]) return ((this.Ma = !0), c.ea[b]);
				if (c.ba && c.ba[b]) e && H(this, this.o, "Cannot set property '" + b + "' of object '" + a + "' which only has a getter");
				else
					try {
						a.h[b] = d;
					} catch (q) {
						e && H(this, this.o, "Cannot assign to read only property '" + b + "' of object '" + a + "'");
					}
			}
		else e && H(this, this.o, "Can't add property '" + b + "', object is not extensible");
	} else e && H(this, this.o, "Can't create property '" + b + "' on '" + a + "'");
};
p.g.Zb = function () {
...
function ja(a, b, d) {
	...
	if (d && d.U) c = !0;
		...
		e && e.pa && "Literal" === e.pa.type && "use strict" === e.pa.value && (c = !0);
	}
	e = a.s(null);
	c = new cd(d, c, e);
	d || Bb(a, c.object);
...
function ed(a, b) {
	...
	if (d === a.M && ad(a, d.object, b)) return a.N(d.object, b);
	d = a.j[a.j.length - 1].node;
	("UnaryExpression" === d.type && "typeof" === d.operator) || H(a, a.pb, b + " is not defined");
}
function fd(a, b, d) {
	...
	if (c === a.M && (!e || ad(a, c.object, b))) return a.g(c.object, b, d);
	...
	if (b.lb) var c = b.lb;
		...
		switch (b.type) {
			case "VariableDeclaration":
				for (var e = 0; e < b.ia.length; e++) c[b.ia[e].id.name] = !0;
				break;
				...
				for (k in b)
					if (b[k] !== b.O) {
						...
						if (q && "object" === typeof q)
							...
							else if (q.constructor === g) for (k in ((C = bb(a, q, d)), C)) c[k] = C[k];
					}
		}
		b.lb = c;
	}
	for (k in c) !0 === c[k] ? a.g(d.object, k, void 0, Ha) : a.g(d.object, k, Pb(a, c[k], d), Ha);
	return c;
}
function Ac(a) {
...
function gd(a, b) {
	return b[0] === Ja ? ed(a, b[1]) : a.N(b[0], b[1]);
}
function hd(a, b, d) {
	return b[0] === Ja ? fd(a, b[1], d) : a.g(b[0], b[1], d);
}
function H(a, b, d) {
	if (!a.M) throw void 0 === d ? b : d;
	void 0 !== d && b instanceof D && ((b = a.ga(b)), Jc(a, b, d));
	id(a, 4, b);
	throw Ia;
}
function id(a, b, d, c) {
	...
	a: for (; 0 < e.length; e.pop()) {
		...
		switch (g.node.type) {
			...
			case "NewExpression":
				...
				if (1 === b || 2 === b) throw Error("Unsyntactic break/continue not rejected by Acorn");
				break;
			case "Program":
				if (3 === b) return;
				g.done = !0;
		...
		} else if (2 === b && (c ? g.labels && -1 !== g.labels.indexOf(c) : g.ca)) return;
	}
...
function Q(a, b) {
	switch (b.type) {
		...
		case "LogicalExpression":
			return Q(a, b.left) + " " + b.operator + " " + Q(a, b.right);
		case "CallExpression":
			return Q(a, b.callee) + "(...)";
		case "ConditionalExpression":
			return Q(a, b.test) + " ? " + Q(a, b.fa) + " : " + Q(a, b.alternate);
		case "Identifier":
			return b.name;
		case "Literal":
			return b.raw;
		case "MemberExpression":
			...
			return b.fb ? d + "[" + a + "]" : d + "." + a;
		case "NewExpression":
			return "new " + Q(a, b.callee) + "(...)";
		case "ObjectExpression":
			return "{...}";
		case "ThisExpression":
			return "this";
		case "UnaryExpression":
			return b.operator + " " + Q(a, b.J);
		case "UpdateExpression":
			return ((d = Q(a, b.J)), b.prefix ? b.operator + d : d + b.operator);
	}
	return "???";
}
function Nb(a, b, d) {
	...
	if (g instanceof D && "Function" === g.H) {
		...
		try {
			var C = da(String(g), "taskCode" + a.hc++);
		} catch (R) {
...
function kd(a, b, d) {
	if (!a.R) throw Error("Unexpected call to createGetter");
	a.R = !1;
...
function ld(a, b, d, c) {
	if (!a.Ma) throw Error("Unexpected call to createSetter");
	a.Ma = !1;
...
function md(a, b) {
	return void 0 === b || null === b ? a.Qa : b instanceof D ? b : ((a = a.s(Bc(a, b))), (a.data = b), a);
}
p.Ub = function () {
	return this.M;
};
...
p.data = null;
p.toString = function () {
	if (!Oa) return "[object Interpreter.Object]";
...
p.valueOf = function () {
	return !Oa || void 0 === this.data || null === this.data || this.data instanceof RegExp ? this : this.data instanceof Date ? this.data.valueOf() : this.data;
};
...
t.prototype.stepArrayExpression = function (a, b, d) {
	d = d.elements;
	var c = b.B || 0;
	b.Ra ? (this.g(b.Ra, c, b.value), c++) : ((b.Ra = Cc(this)), (b.Ra.h.length = d.length));
	for (; c < d.length; ) {
		if (d[c]) return ((b.B = c), new u(d[c], b.scope));
		c++;
	}
	a.pop();
...
t.prototype.stepAssignmentExpression = function (a, b, d) {
	if (!b.na) return ((b.na = !0), (b = new u(d.left, b.scope)), (b.xa = !0), b);
	if (!b.Ga) {
		b.Ia || (b.Ia = b.value);
		b.Ea && (b.qa = b.value);
		if (!b.Ea && "=" !== d.operator && ((a = gd(this, b.Ia)), (b.qa = a), this.R)) return ((b.Ea = !0), kd(this, a, b.Ia));
		b.Ga = !0;
		"=" === d.operator && "Identifier" === d.left.type && (b.Sa = d.left.name);
		return new u(d.right, b.scope);
	}
	if (b.ya) (a.pop(), (a[a.length - 1].value = b.kb));
	else {
		var c = b.qa,
			e = b.value;
		switch (d.operator) {
		...
		if ((d = hd(this, b.Ia, c))) return ((b.ya = !0), (b.kb = c), ld(this, d, b.Ia, c));
		a.pop();
		a[a.length - 1].value = c;
	}
};
t.prototype.stepBinaryExpression = function (a, b, d) {
	if (!b.na) return ((b.na = !0), new u(d.left, b.scope));
	if (!b.Ga) return ((b.Ga = !0), (b.qa = b.value), new u(d.right, b.scope));
	a.pop();
	var c = b.qa;
	b = b.value;
	switch (d.operator) {
		...
		case ">>>":
			...
			break;
		case "in":
			b instanceof D || H(this, this.o, "'in' expects an object, not '" + b + "'");
			d = ad(this, b, c);
			break;
		case "instanceof":
			P(this, b, this.P) || H(this, this.o, "'instanceof' expects an object, not '" + b + "'");
...
t.prototype.stepBlockStatement = function (a, b, d) {
	var c = b.B || 0;
	if ((d = d.body[c])) return ((b.B = c + 1), new u(d, b.scope));
	a.pop();
};
...
t.prototype.stepCallExpression = function (a, b, d) {
	...
	if (1 === b.ma) {
		...
		var e = b.value;
		if (Array.isArray(e)) {
			if (((b.aa = gd(this, e)), e[0] === Ja ? (b.Mb = "eval" === e[1]) : (b.C = e[0]), (e = b.aa), this.R)) return ((b.ma = 1), kd(this, e, b.value));
		} else b.aa = e;
		b.G = [];
		b.B = 0;
	}
	...
	if (!b.Ta) {
		...
		if (d.arguments[b.B]) return new u(d.arguments[b.B++], b.scope);
		if ("NewExpression" === d.type) {
			(e instanceof D && !e.zb) || H(this, this.o, Q(this, d.callee) + " is not a constructor");
			if (e === this.ua) b.C = Cc(this);
			else {
				var g = e.h.prototype;
				if ("object" !== typeof g || null === g) g = this.L;
				b.C = this.s(g);
			}
			b.isConstructor = !0;
		}
	...
	if (b.hb) (a.pop(), (a[a.length - 1].value = b.isConstructor && "object" !== typeof b.value ? b.C : b.value));
	else {
		b.hb = !0;
		e instanceof D || H(this, this.o, Q(this, d.callee) + " is not a function");
		if ((a = e.node)) {
			d = ja(this, a.body, e.Xa);
			c = Cc(this);
			for (e = 0; e < b.G.length; e++) this.g(c, e, b.G[e]);
			this.g(d.object, "arguments", c);
			for (e = 0; e < a.sa.length; e++) this.g(d.object, a.sa[e].name, b.G.length > e ? b.G[e] : void 0);
			d.U || (b.C = md(this, b.C));
		...
		if (e.eval)
			if (((e = b.G[0]), "string" !== typeof e)) b.value = e;
			else {
				try {
		...
		else if (e.Va) (b.scope.U || (b.C = md(this, b.C)), (b.value = e.Va.apply(b.C, b.G)));
		else if (e.bb) {
			var k = this;
			c = e.bb.length - 1;
...
t.prototype.stepConditionalExpression = function (a, b, d) {
	var c = b.ra || 0;
	if (0 === c) return ((b.ra = 1), new u(d.test, b.scope));
	if (1 === c) {
		b.ra = 2;
		if ((c = !!b.value) && d.fa) return new u(d.fa, b.scope);
...
t.prototype.stepDoWhileStatement = function (a, b, d) {
	"DoWhileStatement" === d.type && void 0 === b.ka && ((b.value = !0), (b.ka = !0));
	if (!b.ka) return ((b.ka = !0), new u(d.test, b.scope));
	if (!b.value) a.pop();
	else if (d.body) return ((b.ka = !1), (b.ca = !0), new u(d.body, b.scope));
};
...
t.prototype.stepExpressionStatement = function (a, b, d) {
	if (!b.oa) return ((this.value = void 0), (b.oa = !0), new u(d.pa, b.scope));
	a.pop();
	this.value = b.value;
};
t.prototype.stepForInStatement = function (a, b, d) {
	if (!b.Rb && ((b.Rb = !0), d.left.ia && d.left.ia[0].za)) return (b.scope.U && H(this, this.Y, "for-in loop variable declaration may not have an initializer"), new u(d.left, b.scope));
	if (!b.Fa) return ((b.Fa = !0), b.ta || (b.ta = b.value), new u(d.right, b.scope));
	b.ca || ((b.ca = !0), (b.v = b.value), (b.mb = Object.create(null)));
	if (void 0 === b.Ua)
		a: for (;;) {
			if (b.v instanceof D)
				for (b.Ba || (b.Ba = Object.getOwnPropertyNames(b.v.h)); ; ) {
					var c = b.Ba.shift();
					if (void 0 === c) break;
					if (Object.prototype.hasOwnProperty.call(b.v.h, c) && !b.mb[c] && ((b.mb[c] = !0), Object.prototype.propertyIsEnumerable.call(b.v.h, c))) {
						b.Ua = c;
						break a;
					}
				}
	...
	if (!b.wb)
		if (((b.wb = !0), (a = d.left), "VariableDeclaration" === a.type)) b.ta = [Ja, a.ia[0].id.name];
		else return ((b.ta = null), (b = new u(a, b.scope)), (b.xa = !0), b);
	b.ta || (b.ta = b.value);
	if (!b.ya && ((b.ya = !0), (a = b.Ua), (c = hd(this, b.ta, a)))) return ld(this, c, b.ta, a);
	b.Ua = void 0;
	b.wb = !1;
	b.ya = !1;
...
t.prototype.stepForStatement = function (a, b, d) {
	switch (b.ra) {
		default:
			b.ra = 1;
			if (d.za) return new u(d.za, b.scope);
			break;
		case 1:
			b.ra = 2;
		...
		case 2:
			b.ra = 3;
			if (d.test && !b.value) a.pop();
			else return ((b.ca = !0), new u(d.body, b.scope));
			break;
		case 3:
			if (((b.ra = 1), d.update)) return new u(d.update, b.scope);
	}
};
...
t.prototype.stepIdentifier = function (a, b, d) {
	a.pop();
	if (b.xa) a[a.length - 1].value = [Ja, d.name];
	else {
		b = ed(this, d.name);
		if (this.R) return kd(this, b, this.Qa);
...
t.prototype.stepLiteral = function (a, b, d) {
	a.pop();
	b = d.value;
	b instanceof RegExp && ((d = this.s(this.Pa)), Ic(this, d, b), (b = d));
	a[a.length - 1].value = b;
};
t.prototype.stepLogicalExpression = function (a, b, d) {
	...
	if (!b.na) return ((b.na = !0), new u(d.left, b.scope));
	if (b.Ga) (a.pop(), (a[a.length - 1].value = b.value));
	else if (("&&" === d.operator && !b.value) || ("||" === d.operator && b.value)) (a.pop(), (a[a.length - 1].value = b.value));
	else return ((b.Ga = !0), new u(d.right, b.scope));
};
t.prototype.stepMemberExpression = function (a, b, d) {
	if (!b.Fa) return ((b.Fa = !0), new u(d.object, b.scope));
	if (d.fb)
		if (b.Sb) d = b.value;
		else return ((b.v = b.value), (b.Sb = !0), new u(d.Ya, b.scope));
	else ((b.v = b.value), (d = d.Ya.name));
	a.pop();
	if (b.xa) a[a.length - 1].value = [b.v, d];
	else {
		d = this.N(b.v, d);
		if (this.R) return kd(this, d, b.v);
		a[a.length - 1].value = d;
	}
};
...
t.prototype.stepObjectExpression = function (a, b, d) {
	...
	if (e) {
		var k = e.key;
		if ("Identifier" === k.type) g = k.name;
		else if ("Literal" === k.type) g = k.value;
		else throw SyntaxError("Unknown object structure: " + k.type);
		b.Sa = g;
		return new u(e.value, b.scope);
	}
	for (k in b.La) ((d = b.La[k]), "get" in d || "set" in d ? this.g(b.v, k, Ka, { configurable: !0, enumerable: !0, get: d.get, set: d.set }) : this.g(b.v, k, d.init));
	a.pop();
...
t.prototype.stepReturnStatement = function (a, b, d) {
	if (d.J && !b.oa) return ((b.oa = !0), new u(d.J, b.scope));
	id(this, 3, b.value);
};
t.prototype.stepSequenceExpression = function (a, b, d) {
	var c = b.B || 0;
	if ((d = d.xb[c])) return ((b.B = c + 1), new u(d, b.scope));
	a.pop();
	a[a.length - 1].value = b.value;
};
t.prototype.stepSwitchStatement = function (a, b, d) {
	if (!b.ka) return ((b.ka = 1), new u(d.Nb, b.scope));
	...
	for (;;) {
		...
		if (b.Ka || !e || e.test)
			if (e || b.Ka || -1 === b.gb)
				if (e) {
					if (!b.Ka && !b.Db && e.test) return ((b.Db = !0), new u(e.test, b.scope));
					if (b.Ka || b.value === b.fc) {
						b.Ka = !0;
						var g = b.B || 0;
						if (e.fa[g]) return ((b.Xb = !0), (b.B = g + 1), new u(e.fa[g], b.scope));
					}
					b.Db = !1;
					b.B = 0;
					b.jb = c + 1;
...
t.prototype.stepThrowStatement = function (a, b, d) {
	if (b.oa) H(this, b.value);
	else return ((b.oa = !0), new u(d.J, b.scope));
};
t.prototype.stepTryStatement = function (a, b, d) {
	if (!b.Ob) return ((b.Ob = !0), new u(d.block, b.scope));
	if (b.ha && 4 === b.ha.type && !b.Qb && d.Ha) return ((b.Qb = !0), (a = dd(this, b.scope)), this.g(a.object, d.Ha.Wa.name, b.ha.value), (b.ha = void 0), new u(d.Ha.body, a));
	if (!b.Pb && d.ib) return ((b.Pb = !0), new u(d.ib, b.scope));
	a.pop();
	b.ha && id(this, b.ha.type, b.ha.value, b.ha.label);
};
t.prototype.stepUnaryExpression = function (a, b, d) {
	if (!b.oa) return ((b.oa = !0), (a = new u(d.J, b.scope)), (a.xa = "delete" === d.operator), a);
	a.pop();
	var c = b.value;
	switch (d.operator) {
		case "-":
		...
		case "delete":
			...
			if (Array.isArray(c)) {
				...
				try {
					...
					b.scope.U ? H(this, this.o, "Cannot delete property '" + c + "' of '" + e + "'") : (d = !1);
				}
			}
			c = d;
			break;
...
t.prototype.stepUpdateExpression = function (a, b, d) {
	if (!b.na) return ((b.na = !0), (a = new u(d.J, b.scope)), (a.xa = !0), a);
	b.Ja || (b.Ja = b.value);
	b.Ea && (b.qa = b.value);
	if (!b.Ea) {
		var c = gd(this, b.Ja);
		b.qa = c;
		if (this.R) return ((b.Ea = !0), kd(this, c, b.Ja));
	}
	if (b.ya) (a.pop(), (a[a.length - 1].value = b.kb));
	else {
		c = Number(b.qa);
		if ("++" === d.operator) var e = c + 1;
		else if ("--" === d.operator) e = c - 1;
		else throw SyntaxError("Unknown update expression: " + d.operator);
		d = d.prefix ? e : c;
		if ((c = hd(this, b.Ja, e))) return ((b.ya = !0), (b.kb = d), ld(this, c, b.Ja, e));
		a.pop();
		a[a.length - 1].value = d;
	}
};
t.prototype.stepVariableDeclaration = function (a, b, d) {
	...
	var c = b.B || 0,
		e = d[c];
	b.Ab && e && (fd(this, e.id.name, b.value), (b.Ab = !1), (e = d[++c]));
	for (; e; ) {
		if (e.za) return ((b.B = c), (b.Ab = !0), (b.Sa = e.id.name), new u(e.za, b.scope));
		e = d[++c];
	}
	a.pop();
};
